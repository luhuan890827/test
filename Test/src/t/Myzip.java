...
public class Myzip {  
    ...
    public static void main(String[] args) {  
        ...
        //zip ("e:\\test", "D:\\测试结果.zip");  
  
        //unZip("D:\\测试结果.zip", "D:\\解压结果"); 
    	try{
    		goThrough("E:\\phone-mag\\house\\12月");
    	}catch(Exception e){
    		e.printStackTrace();
    	}
    ...
    public static void goThrough(String fPath) throws IOException{
    	File fFolder = new File(fPath);
    	
    	File[] folders = fFolder.listFiles();
    		...
    		if(subFolders!=null){
    			for (File subFolder : subFolders) {
    				if(subFolder.isDirectory()){
    					...
    					zip(subFolder.getAbsolutePath(),prefix+subFolder.getName()+".zip");
    				}
